...
<body class="signup-page">
    ...
    <div class="wrapper">
		<div class="header header-filter" style="background-image: url('${pageContext.request.contextPath }/img/signin-bg2.jpg'); background-size: cover; background-position: top center;">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup">
						    ...
						    <!-- 登录表单 -->
							<form:form class="form" method="post" modelAttribute="login" action="${pageContext.request.contextPath }/hotelstaff/signin">
								<c:if test="${requestScope.orderUrl != null }"> 
									<input type="hidden" name="orderUrl" value="${ requestScope.orderUrl }">
								</c:if>
								<div class="header text-center header-success ">
									<h4>Echo 酒店工作人员 登录</h4>
								</div>
								...
								<div class="content">
									...
									<div class="input-group">
										<span class="input-group-addon">
											<img src="${pageContext.request.contextPath }/captcha-image"  id="kaptchaImage"  style="margin-bottom: -3px" width="100px;" height="40px;">
									    </span>
								...
								<div class="footer text-center">
									<input type="submit" class="btn btn-simple btn-success btn-lg" value="登录">
								</div>
							</form:form>
							<!-- 登录表单END -->
						</div>
