...
<body class="signup-page">
    ...
    <div class="wrapper">
		<div class="header header-filter" style="background-image: url('${pageContext.request.contextPath }/img/signin-bg4.jpg'); background-size: cover; background-position: top center;">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup"  style="background-color: rgba(211,211,211,0.2);">
							...
							<form:form class="form" method="post" modelAttribute="login" action="${pageContext.request.contextPath }/admin/signin">
								...
								<div class="header text-center" style="background-color: #333333;">
									<h4 style="color: white;">Echo 网站管理人员 登录</h4>
								</div>
								...
								<div class="content" >
									...
									<div class="input-group">
										...
										<span class="input-group-addon">
											<img src="${pageContext.request.contextPath }/captcha-image"  id="kaptchaImage"  style="margin-bottom: -3px" width="80px;" height="30px;">
									    </span>
								...
								<div class="footer text-center">
									<input type="submit" class="btn btn-simple  btn-lg" value="登录">
								</div>
							</form:form>
							<!-- 登录表单END -->
						</div>
